...
# 输入的数据(除圣遗物可变词条数据)
#技能倍率/基础攻击/攻击百分比加成/暴击率/暴击伤害/伤害加成/元素精通/抗性/减防数值/无视防御百分比/怪物等级/固定数值加成/基础加成次数/基础加成/独立乘区
skillMultiplier = 18.05
baseAttack = 1300
attackBonusPercentage = 3.312
critRate = 1
critDamage = 2.246
damageBonus = 4.232
elementalMastery = 650
resistance = -0.75
...
def calculateBaseMultiplier(ChangeskillMultiplier,ChangebaseAttack,ChangeattackBonusPercentage,ChangeflatBonus,ChangebaseBonusCount,ChangebaseBonus):
    ChangeBaseMultiplier = ChangeskillMultiplier*(ChangebaseAttack*(1+ChangeattackBonusPercentage)+ChangeflatBonus)+ChangebaseBonusCount*ChangebaseBonus
...
print("当前配队: 玛茜希芙 目前圣遗物词条数:",artifactStatCount)
print('最优解(攻击/暴击/爆伤/精通):',best_solution)
print("沙漏/杯子/头部: 攻击/攻击/爆伤")
